...
5. The main application class (IntelliDBApp) that ties everything together.
...
# ------------------------------
class Config:
    PAGE_TITLE = "IntelliDB Enterprise"
    VERSION = "17.2"
    DEFAULT_HOST = "localhost"
    DEFAULT_PORT = "5555"
    DEFAULT_DATABASE = "intellidb"
    ...
    def render_database_info(db_manager: DatabaseManager):
        ...
        try:
            ...
            with col2:
                ...
                st.metric("IntelliDB Enterprise Version", Config.VERSION)
...
class MonitoringTools:
    ...
    def render_monitoring_tab(monitor):
        ...
        st.header("🔍 IntelliDB Monitoring Tools")
        ...
        if st.button("Run Diagnostic"):
            if tool in ["Query Performance", "Transaction Analysis", "Storage Analysis", "Buffer Analysis", "Checkpoint Activity", "Lock Analysis", "Vacuum Analysis", "Cache Analysis", "Growth Analysis"]:
                if tool == "Query Performance":
                    ...
                    st.markdown("""
                        ### **🔹 Purpose**  
                        - Monitors **timed and requested checkpoints** to analyze how often IntelliDB is flushing dirty pages to disk.  
